...
const privateDataSchema = schema.z
  .object({
    ...
    'Cách Chơi Yêu Thích': schema.z.string().prefault('Chờ AI điền vào'),
...
const physiologicalStateSchema = schema.z
  .object({
    'Bôi Trơn Âm Đạo': schema.z.string().prefault('Chờ AI điền vào'),
...
const heroineSchema = schema.z
  .object({
    ...
    'Vị Trí Dấu Tacet': schema.z.string().prefault('Chờ AI điền vào'),
